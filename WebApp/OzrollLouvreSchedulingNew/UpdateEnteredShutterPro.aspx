<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateEnteredShutterPro.aspx.vb" Inherits="UpdateEnteredShutterPro" Theme="SknGridView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Entered Into Shutter Pro Update</title>
    ...
    <link href="favicon.ico" rel="shortcut icon" type="image/x-icon" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            $("[id$=txtShutterProDate]").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1d', maxDate: '+5w' });
...
<body onload="saveLocation();">
    ...
    <div id="middle-container-diallerview" >
        ...
        <h1>Entered Into Shutter Pro Update</h1>

        <div class="form" style="text-align: center;">

            <div style="text-align: center;">
                Entered Shutter Pro Date:&nbsp;<asp:TextBox ID="txtShutterProDate" runat="server" CssClass="form-field" Text="" Width="120px" />
            </div>
            ...
            <ContentTemplate>
                ...
                <div style="text-align: center;">
                    <asp:GridView ID="dgvShutterProList" runat="server" DataKeyNames="ScheduleID" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Entered">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chkEntered" Checked='<%#Convert.ToBoolean(Eval("ShutterPro")) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
    ...
    <script type="text/javascript">
        $(function () {
            $("input#txtShutterProDate").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1d', maxDate: '+5w' });
        });
    </script>
