<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LouvreJobDetailsQuick.aspx.vb" Inherits="LouvreJobDetailsQuick" Theme="SknGridView" EnableEventValidation="false" %>
...
<body onload="HideHider();">
        ...
        <div id="middle-container-diallerview">
            ...
            <asp:UpdatePanel ID="pnlDetails" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                        ...
                        <div style="text-align: center;">
                            <asp:Panel ID="pnlAcceptanceAlert" runat="server" Visible="false">
                                <div style="width: 100%; height: 30px; left: 0px; top: 0px; z-index: 100; background-color: Red; color: White; font-weight: bold; text-align: center; padding: 10px 0px 10px 0px;">
                                    This job requires action before acceptance to production.
                                    <br />
                        ...
                        <div class="container_24">
                            <div class="grid_25">
                                <div class="grid_26 alpha">
                                    <!--left hand side information for the order-->
                                    <table class="form-table" style="width: 100%; text-align: center;" cellspacing="0" summary="">
                                        ...
                                        <tr>
                                            <td class="form-label-td" style="width: 30%; text-align: right;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="form-label-td" style="width: 70%; text-align: left;">
                                                <asp:TextBox ID="txtSalePrice" runat="server" CssClass="form-field" OnChange="javascript:validfloat();" Text="" Width="100px" Enabled="false" />
                                                ex GST
                                            </td>
                                        </tr>
                                        ...
                                        <asp:Panel ID="pnlFreightTotal" runat="server">
                                            <tr>
                                                ...
                                                <td class="form-label-td" style="width: 70%; text-align: left;">
                                                    <asp:TextBox ID="txtFreightTotal" runat="server" CssClass="form-field" OnChange="javascript:validfloat();" Text="" Width="100px" Enabled="false" />
                                                    ex GST
                                    ...
                                    <asp:Panel ID="pnlUploadFiles" runat="server" CssClass="file-upload-panel" Visible="false">
                                        ...
                                        <div style="font-style: italic; padding-bottom: 10px;">
                                            <asp:Label ID="lblProdScheduleFilesSupportedFormats" runat="server" Text="" /></div>
                                ...
                                <div class="grid_27 omega">
                                    <!--right hand side information for the order and statuses-->
                                    <div>
                                        <!--current status and hold-->
                                        <table class="form-table" style="width: 100%; text-align: center;" cellspacing="0" summary="">
                                            <tr>
                                    ...
                                    <div class="column">
                                        ...
                                        <table class="form-table" style="width: 100%; text-align: center;" cellspacing="0" summary="">
                                            <tr>
                                                <td class="form-label-td quote" style="width: 22%; text-align: right;">
                                                    <asp:Label runat="server" ToolTip="Quote">Created</asp:Label></td>
                                            ...
                                            <tr>
                                                <td class="form-label-td awaitingAcceptance" style="width: 22%; text-align: right;">
                                                    <asp:Label runat="server" ToolTip="Awaiting Acceptance">Ordered</asp:Label></td>
                                            ...
                                            <asp:Panel ID="pnlShowHideTextBox" runat="server">
                                                <tr>
                                                    <td class="form-label-td orderAccepted" style="width: 22%; text-align: right;">
                                                        <asp:Label runat="server" ToolTip="Paperwork Processing">Received</asp:Label></td>
                                            ...
                                            <asp:Button ID="btnAcceptOrder" runat="server" Text="Accept Order" CssClass="form-button" Visible="false" Width="150px" />
                                                ...
                                                <asp:Panel ID="pnlCheckMeasureDate" runat="server" Visible="false">
                                                    <tr>
                                                        <td class="form-label-td checkMeasure" style="width: 22%; text-align: right;">
                                                            <asp:Label runat="server" ToolTip="Check Measure">Check Measure</asp:Label></td>
                                                ...
                                                <tr>
                                                    <td class="form-label-td picking" style="width: 22%; text-align: right;">
                                                        <asp:Label runat="server" ToolTip="Picking">Picking</asp:Label></td>
                                            ...
                                            <asp:Button ID="btnPickingList" runat="server" Text="Picking List" CssClass="form-button" Visible="false" Width="150px" />
                                                ...
                                                <tr>
                                                    <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                        <asp:Label runat="server" ToolTip="In Production">In Production</asp:Label></td>
                                            ...
                                            <asp:Button ID="btnClearScheduled" runat="server" CssClass="form-button" Visible="false" Text="Clear" CommandArgument="txtScheduledDate" />
                                                ...
                                                <tr>
                                                    <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                        <asp:Label runat="server" ToolTip="In Production">Cutting</asp:Label></td>
                                                    <td class="form-label-td inProduction" style="text-align: left;">
                                            ...
                                            <asp:Button ID="btnClearCutting" runat="server" CssClass="form-button" Visible="false" Text="Clear" CommandArgument="txtCuttingDate" />
                                                ...
                                                <tr>
                                                    <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                        <asp:Label runat="server" ToolTip="In Production">Pinning</asp:Label></td>
                                                    <td class="form-label-td inProduction" style="text-align: left;">
                                            ...
                                            <asp:Button ID="btnClearPining" runat="server" CssClass="form-button" Visible="false" Text="Clear" CommandArgument="txtPiningDate" />
                                                ...
                                                <tr>
                                                    <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                        <asp:Label runat="server" ToolTip="In Production">Prep</asp:Label></td>
                                                    <td class="form-label-td inProduction" style="text-align: left;">
                                            ...
                                            <asp:Button ID="btnClearPrep" runat="server" CssClass="form-button" Text="Clear" Visible="false" CommandArgument="txtPrepDate" />
                                                    ...
                                                    <tr>
                                                        <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                            <asp:Label runat="server" ToolTip="In Production">Assembly</asp:Label></td>
                                                        <td class="form-label-td inProduction" style="text-align: left;">
                                            ...
                                            <asp:Button ID="btnClearAssembly" runat="server" CssClass="form-button" Text="Clear" Visible="false" CommandArgument="txtAssemblyDate" />
                                                    ...
                                                    <tr>
                                                        <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                            <asp:Label runat="server" ToolTip="In Production">Hinging</asp:Label></td>
                                                        <td class="form-label-td inProduction" style="text-align: left;">
                                            ...
                                            <asp:Button ID="btnClearHinging" runat="server" CssClass="form-button" Text="Clear" Visible="false" CommandArgument="txtHingingDate" />
                                                    ...
                                                    <tr>
                                                        <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                            <asp:Label runat="server" ToolTip="In Production">Packup</asp:Label></td>
                                                        <td class="form-label-td inProduction" style="text-align: left;">
                                           ...
                                           <asp:Button ID="btnPackUp" runat="server" Text="Packup" CssClass="form-button" Visible="false" Width="150px" />
                                                    ...
                                                    <tr>
                                                        <td class="form-label-td inProduction" style="width: 22%; text-align: right;">
                                                            <asp:Label runat="server" ToolTip="In Production">QC</asp:Label></td>
                                                        <td class="form-label-td inProduction" style="text-align: left;">
                                            ...
                                            <asp:Button ID="btnDispatchDate" runat="server" Text="Despatch" CssClass="form-button" Visible="false" Width="150px" />
                                                    ...
                                                    <asp:Panel ID="pnlInstallDate" runat="server" Visible="false">
                                                        <tr>
                                                            <td class="form-label-td installed" style="width: 22%; text-align: right;">
                                                                <asp:Label runat="server" ToolTip="Installed">Install</asp:Label></td>
                                    ...
                                    <div>
                                        <!--other info remaining under status areas-->
                                        <table class="form-table" style="width: 100%; text-align: center;" cellspacing="0" summary="">
                    ...
                    <asp:Panel ID="pnlRemakeDetails" runat="server" CssClass="modalPopup-louvredetails" Style="display: none; max-height: 95%; max-width: 700px !important">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="pnlAddLouvers" runat="server">
                                    ...
                                    <div class="div-column">
                                        ...
                                        <table id="column1" class="form-table" cellspacing="0" summary="" style="margin-left: -35px;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="form-field-td-p2 no-wrap">
                                                    <asp:TextBox ID="txtLocation" runat="server" AutoPostBack="true" CssClass="form-field" MaxLength="100" usesubmitbehavior="false" Width="140px" />
                                            ...
                                            <tr>
                                                ...
                                                <td class="form-field-td-p2 no-wrap">
                                                    ...
                                                    <asp:TextBox ID="txtColour" runat="server" CssClass="form-field" Width="140px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="form-field-td-p2">
                                                        ...
                                                        <asp:TextBox ID="txtHeight" runat="server" AutoPostBack="true" CssClass="form-field" MaxLength="4" usesubmitbehavior="false" Width="140px" />
                                                        (mm)
                                            <asp:Image ID="imgHeight" runat="server" Height="16px" ImageUrl="images/info_button_icon16x16_t35.png" Width="16px" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="form-field-td-p2">
                                                        ...
                                                        <asp:TextBox ID="txtWidth" runat="server" AutoPostBack="true" CssClass="form-field" MaxLength="6" usesubmitbehavior="false" Width="140px" />
                                                        (mm)
                                    ...
                                    <div class="div-column">
                                        <table id="column2" class="form-table" cellspacing="0" summary="" style="margin-left: 88px !important;">

                                            <asp:Panel ID="pnlEndCapColour" runat="server" Visible="false">
                                                <tr>
                                            ...
                                            <asp:Panel ID="pnlBladeClipColour" runat="server" Visible="false">
                                                <tr>
                                            ...
                                            <%--added by surendra ticket #63195--%>
                                            <asp:Panel ID="pnlPileColour" runat="server" Visible="false">
                                                <tr>
 ...
 <tr style="display:none">
                                            ...
                                            <asp:Panel ID="pnlCurvedTrack" runat="server" Visible="false">
                                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-field-td-p2 no-wrap" >
                                            ...
                                            <asp:Panel ID="pnlFlushBoltsPosition" runat="server" Visible="false">
                                                <tr>
                                                    <td class="form-label-td-p2 no-wrap" style="text-align: right;">Flush Bolts L/R</td>
                                                    <td class="form-field-td-p2 no-wrap">

                                                        <asp:DropDownList ID="cboFlushBoltsPosition" runat="server" AutoPostBack="true" CssClass="form-select" Width="150px">
                                                            <asp:ListItem Selected="true" Text="" Value="0"></asp:ListItem>
 ...
 <tr style="display:none">
                                    ...
                                    <div style="clear: both; display: none;">
                                        <table class="form-table" cellspacing="0" summary="">
                                            <tr>
                                                <td class="form-label-td-p2" style="width: 13%; text-align: right;">Special Requirements
                                                </td>
                                                <td class="form-field-td-p2 no-wrap" style="width: 47%">
                                                    <asp:TextBox ID="txtSpecialRequirements" runat="server" CssClass="form-field" TextMode="MultiLine" Width="42%" Height="50px"></asp:TextBox>
                                ...
                                <td class="form-submit-td" style="text-align: center;">
                                    ...
                                    <tr>
                                        <td class="form-submit-td" style="text-align: center;">
                                            <asp:UpdatePanel ID="pnlupdateSaveCancel" runat="server" UpdateMode="Conditional">
                                                ...
                                                <asp:Button ID="btnSaveDetails" runat="server" CssClass="form-button update-disable" ValidationGroup="details" Text="Submit" UseSubmitBehavior="false" Width="100px" />
                                    ...
                                    <tr>
                                        <td style="text-align:center;"><asp:Label ID="lblSalePriceShow" runat="server" style="color: red;" ></asp:Label></td> 
                                    </tr>
                                    <tr>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlAddNote" runat="server" Visible="false">
                                    <table class="form-table" cellspacing="0" summary="">
                                        <tr>
                                            <td class="form-field-td-p2" style="text-align: right;">Note:&nbsp;&nbsp; 
                                            </td>
                                            <td class="form-field-td-p2">
                            ...
                            <ContentTemplate>
                                ...
                                <table class="form-table" cellspacing="0" summary="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-field-td-p2">Return Date
                                        </td>
                                        <td class="form-field-td-p2">
                            ...
                            <ContentTemplate>
                                ...
                                <table class="form-table" cellspacing="0" summary="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-field-td-p2" colspan="1">Return Date                                    
                                        </td>
                                        <td class="form-field-td-p2">
                    ...
                    <asp:Panel ID="pnlOutstandingItems" runat="server" CssClass="modalPopup" Style="display: none;">
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <table class="form-table" cellspacing="0" summary="">
                                    <tr>
                                        <td class="form-field-td-p2" colspan="2">Confirm all the items below have been attended to before completing acceptance
                                        </td>
                                    </tr>
                                    <tr>
