...
Partial Class LouvreJobDetailsQuick
    ...
    Private Sub LouvreJobDetailsQuick_PreRender(sender As Object, e As EventArgs) Handles Me.PreLoad
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            AddDetailMethod()
            cboFlushBoltsPosition.SelectedValue = "2"
            cboCurvedTrack.SelectedValue = "1"
...
#Region "Shutter Details Function"
    ...
    Protected Sub btnSaveDetails_Click(sender As Object, e As System.EventArgs) Handles btnSaveDetails.Click
        ...
        'If Not 
        Dim cCustomer As Customer = _Service.GetCustomerByID("8")
        txtEnteredDatetime.Text = Format(Now, "d MMM yyyy")
        InitCosting(cCustomer, txtEnteredDatetime.Text)
        SaveDetails() ' Then
        ' Keep the popup
    ...
    Public Sub SaveDetails()
        ...
        Dim salePrice As Decimal = 0.00
        lblSalePriceShow.Text = ""
        ...
        If cLouvreJobDetails IsNot Nothing Then
            ...
            If cLouvreJobDetails.ShutterTypeId = LouvreTypes.PrivacyScreen Then
                If ucPrivacyScreenDetails.DetailsNeedCostRecalculation(cOriginalLouvreJobDetails) Then
                    salePrice = _Costing.GetLouvrePrice(cLouvreJobDetails, cExtras, cLouvrePriceFound, lExtraPriceIDsNotFound)
        ...
        Else
            ...
            'Return False
        End If
        lblSalePriceShow.Text = salePrice
        'Return True
    End Sub
    ...
    Protected Function LoadShutterDetailsToPopup(intPSDetailID As Integer) As LouvreDetails
        ...
        If cQuoteDetail.LouvreDetailID <> 0 Then
            ...
            ' _RulesLouvreDetails.PopulateHingesDDL(cQuoteDetail.ProductId, cQuoteDetail.ShutterTypeId, cQuoteDetail.BiFoldHingedDoorInOutId, cQuoteDetail.Hinges)
    ...
    Protected Sub ResetPopupControlsToDefault()
        ...
        cboEndCapColour.SelectedIndex = 1
