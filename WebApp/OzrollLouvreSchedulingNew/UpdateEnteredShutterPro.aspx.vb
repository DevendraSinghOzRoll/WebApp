...
Partial Class UpdateEnteredShutterPro
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.txtShutterProDate.Text = Format(DateTime.Now, "d MMM yyyy")
    ...
    Protected Function loadDatatable() As DataTable
        ...
        For i As Integer = 0 To dtMain.Rows.Count - 1
            ...
            drow("ShutterProDate") = DBNull.Value
            drow("ShutterPro") = False
            dt.Rows.Add(drow)
            drow = Nothing
        Next
        Return dt
    ...
    Protected Function createDatatable() As DataTable
        ...
        col = New DataColumn
        col.ColumnName = "ShutterProDate"
        col.DataType = System.Type.GetType("System.DateTime")
        dt.Columns.Add(col)
        col = Nothing

        col = New DataColumn
        col.ColumnName = "ShutterPro"
        ...
        Try
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                If bolContinue Then
                    ...
                    cNewProductionSchedule.OrderStatus = 6 'entered shutter pro
                    cNewProductionSchedule.EnteredShutterProDate = CDate(Me.txtShutterProDate.Text)
            ...
            If bolContinue Then
                trans.Commit()
                Response.Redirect("UpdateEnteredShutterPro.aspx", False)
            Else
    ...
    Protected Function setEnteredValues() As DataTable
        ...
        For Each gvr As GridViewRow In Me.dgvShutterProList.Rows
            ...
            If chk.Checked Then
                ...
                drow("ShutterProDate") = Me.txtShutterProDate.Text
                drow("ShutterPro") = True
                dt.Rows.Add(drow)
            End If
            drow = Nothing
        Next
