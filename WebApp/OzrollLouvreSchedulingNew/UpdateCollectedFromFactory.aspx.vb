...
Partial Class UpdateCollectedFromFactory
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.txtCollectedDate.Text = Format(DateTime.Now, "d MMM yyyy")

            Dim dt As DataTable = loadDatatable()
            Me.dgvCollectedList.DataSource = dt
            Me.dgvCollectedList.DataBind()
    ...
    Protected Function loadDatatable() As DataTable
        ...
        Dim dtMain As DataTable = service.getToBeCollectedFromFactory(CInt(Me.txtProductTypeID.Text))
        service = Nothing
        ...
        For i As Integer = 0 To dtMain.Rows.Count - 1
            ...
            drow("CollectedDate") = DBNull.Value
            drow("Collected") = False
    ...
    Protected Function createDatatable() As DataTable
        ...
        col = New DataColumn
        col.ColumnName = "CollectedDate"
        col.DataType = System.Type.GetType("System.DateTime")
        dt.Columns.Add(col)
        col = Nothing

        col = New DataColumn
        col.ColumnName = "Collected"
        ...
        Try
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                If bolContinue Then
                    ...
                    cNewProductionSchedule.OrderStatus = 7 'collected
                    cNewProductionSchedule.CollectedFactoryDate = CDate(Me.txtCollectedDate.Text)
            ...
            If bolContinue Then
                trans.Commit()
                Response.Redirect("UpdateCollectedFromFactory.aspx", False)
            Else
    ...
    Protected Function setCollectedValues() As DataTable
        ...
        For Each gvr As GridViewRow In Me.dgvCollectedList.Rows
            intID = CInt(dgvCollectedList.DataKeys(gvr.RowIndex).Value)
            Dim chk As CheckBox = DirectCast(gvr.FindControl("chkCollected"), CheckBox)
            If chk.Checked Then
                'update to completed
                drow = dt.NewRow
                drow("ScheduleID") = intID
                drow("PlannedShippingDate") = Me.txtCollectedDate.Text
                dt.Rows.Add(drow)
            End If
            drow = Nothing
        Next
