<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateAwaitingInvoicing.aspx.vb" Inherits="UpdateAwaitingInvoicing" Theme="SknGridView"  %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Awaiting Invoicing Update</title>
    ...
    <link href="favicon.ico" rel="shortcut icon" type="image/x-icon" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            $("[id$=txtInvoiceDate]").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1w', maxDate: '+5w' });
...
<body onload="saveLocation();">
    ...
    <div id="middle-container-diallerview" >
        ...
        <h1>To Be Invoiced Update</h1>

        <div class="form" style="text-align: center;">

            <div style="text-align: center;">
                Invoice Date:&nbsp;<asp:TextBox ID="txtInvoiceDate" runat="server" CssClass="form-field" Text="" Width="120px" />
            </div>
            ...
            <ContentTemplate>
                ...
                <div style="text-align: center;">
                    <asp:GridView ID="dgvInvoicingList" runat="server" DataKeyNames="ScheduleID" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Failed" Visible="false">
                                <ItemTemplate>
                                    <asp:label runat="server" ID="lblFailed" text='<%# (Eval("Failed")) %>' Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateField> 
                            ...
                            <asp:TemplateField HeaderText="Stock Deductions">
                                <ItemTemplate>
                                    <asp:label runat="server" ID="lblStockDeductions" text='<%# GetStockDeductionText(DirectCast(GetDataItem(), DataRowView).Row) %>' />
                                </ItemTemplate>
                            </asp:TemplateField> 
                                                   
                            <asp:TemplateField HeaderText="Invoice">
                                <ItemTemplate>
                                    <asp:HiddenField runat="server" ID="hidCollectFactory" Value='<%#(Eval("CollectionFromFactory")) %>' />
                                    <asp:CheckBox runat="server" ID="chkInvoice" CssClass="checkbox" Checked='<%#Convert.ToBoolean(Eval("Invoiced")) %>' />
                                    <asp:HiddenField runat="server" ID="hidShippingDetails" Value='<%#(Eval("ShippingDetails")) %>' />
                                    <asp:HiddenField runat="server" ID="hidCustomerID" Value='<%#(Eval("CustomerId")) %>' />
                                     </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Error" Visible="false">
                                <ItemTemplate>
                                    <asp:label runat="server" ID="lblInvoiceFailed" ForeColor="Red" Font-Bold="true" Visible='<%#(Eval("Failed")) %>' text='<%#(Eval("StatusMessage")) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                    ...
                    <tr>
                        <td class="form-submit-td"  style="width: 50%; text-align: center;">
                            ...
                            <asp:Button ID="btnSave" runat="server" CssClass="form-button" Text="Save" UseSubmitBehavior="false" OnClientClick="saveClick();" />
                        </td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        $(function () {
            $("input#txtInvoiceDate").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1w', maxDate: '+5w' });
        });
    </script>
