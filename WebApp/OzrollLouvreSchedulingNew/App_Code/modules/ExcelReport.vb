...
Public Class ExcelReport
    ...
    Shared Sub populateDataROW(ByRef intDBrows As Integer, ByRef intRowNum As Integer, ByRef dtScheduleListTBL As DataTable, ByRef dtWKMonthsTBL As DataTable, ByRef xlWks As ExcelWorksheet)
        ...
        For intDBrows = 0 To dtScheduleListTBL.Rows.Count - 1
            ...
            End If
            intColNum += 1
            If clsProdSchedule.CustomerID <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = dtScheduleListTBL.Rows(intDBrows)("Customer").ToString
            End If
            intColNum += 1
            If clsProdSchedule.OrderStatus <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            ...
            End If
            intColNum += 1
            If clsProdSchedule.PanelsLess700 <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.PanelsLess700
            End If
            intColNum += 1
            If clsProdSchedule.PanelsMore700 <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.PanelsMore700
            End If
            intColNum += 1
            If clsProdSchedule.QtyHinges <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.QtyHinges
            End If
            intColNum += 1
            If clsProdSchedule.QtySliding <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.QtySliding
            End If
            intColNum += 1
            If clsProdSchedule.QtyBifold <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.QtyBifold
            End If
            intColNum += 1
            If clsProdSchedule.QtyFixed <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.QtyFixed
            End If
            intColNum += 1
            If clsProdSchedule.QtyZFrame <> SharedConstants.DEFAULT_INTEGER_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.QtyZFrame
            End If
            intColNum += 1
            If clsProdSchedule.QtyLFrame <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            ...
            End If
            intColNum += 1
            If clsProdSchedule.SalePrice <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
                xlWks.Cells(intRowNum, intColNum).Value = clsProdSchedule.SalePrice
            End If
            intColNum += 1
            If clsProdSchedule.FreightAmount <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            ...
            intColNum += 1
            xlWks.Cells(intRowNum, intColNum).Value = dtScheduleListTBL.Rows(intDBrows)("RemakeIssueDescription").ToString()
    ...
    Shared Function getAllweekmonth() As DataTable
        ...
        Dim strSQL As String = "Select loctblWeeks.WeekId, loctblWeeks.WeekNumber, loctblMonths.MonthID, loctblMonths.MonthName, loctblMonths.YearID " & _
