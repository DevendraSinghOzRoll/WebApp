...
Partial Class readExcel
    ...
    Private Sub saveLouvreDetsToDB(ByRef intCNT As Integer, ByRef arrLouvreDetCls As List(Of LouvreDetails), ByVal strCompanyName As String, ByVal strLastName As String,
        ...
        Dim intProductScheduleID As Integer = SharedConstants.DEFAULT_INTEGER_VALUE
        ...
        Try
            ...
            If intProductScheduleID = SharedConstants.DEFAULT_INTEGER_VALUE Then
                bolContinue = False
            End If
            ...
            If bolContinue Then
                ...
                If clsLouvreSpecs.ColourID <> SharedConstants.DEFAULT_INTEGER_VALUE Then
    ...
    Private Sub covertClSsToTBL(ByRef intCNT As Integer, ByRef dtLouvreDets As DataTable, ByRef arrLouvreDetCls As List(Of LouvreDetails))
        ...
        '
        If arrLouvreDetCls(intCNT).ProductionScheduleID <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("ProductionScheduleId") = arrLouvreDetCls(intCNT).ProductionScheduleID
        End If
        '
        If arrLouvreDetCls(intCNT).ShutterID = SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        If arrLouvreDetCls(intCNT).Location <> String.Empty Then
            ...
            Else
                ...
                dr("LocationId") = SharedConstants.DEFAULT_INTEGER_VALUE
                dr("OtherLocation") = arrLouvreDetCls(intCNT).Location
            End If
        End If
        '
        If arrLouvreDetCls(intCNT).Width <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("Width") = arrLouvreDetCls(intCNT).Width
        End If
        If arrLouvreDetCls(intCNT).Height <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("Height") = arrLouvreDetCls(intCNT).Height
        End If
        If arrLouvreDetCls(intCNT).MakeOrOpenSizesId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        '
        If arrLouvreDetCls(intCNT).ShutterTypeId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        If arrLouvreDetCls(intCNT).ShutterType <> String.Empty Then
        End If
        If arrLouvreDetCls(intCNT).BiFoldHingedDoorInOutId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).NoOfPanels <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("NoOfPanels") = arrLouvreDetCls(intCNT).NoOfPanels
        End If
        If arrLouvreDetCls(intCNT).NoOfOpenings <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("NoOfOpenings") = arrLouvreDetCls(intCNT).NoOfOpenings
        End If
        If arrLouvreDetCls(intCNT).BladeSizeId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("BladeSizeId") = arrLouvreDetCls(intCNT).BladeSizeId
        End If
        If arrLouvreDetCls(intCNT).BladeSize <> String.Empty Then
            dr("BladeSize") = arrLouvreDetCls(intCNT).BladeSize
        End If
        If arrLouvreDetCls(intCNT).EndCapColourId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("EndCapColourId") = arrLouvreDetCls(intCNT).EndCapColourId
        End If
        If arrLouvreDetCls(intCNT).EndCapColour <> String.Empty Then
            dr("EndCapColour") = arrLouvreDetCls(intCNT).EndCapColour
        End If
        If arrLouvreDetCls(intCNT).BladeClipColourId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("BladeClipColourId") = arrLouvreDetCls(intCNT).BladeClipColourId
        End If
        If arrLouvreDetCls(intCNT).BladeClipColour <> String.Empty Then
            dr("BladeClipColour") = arrLouvreDetCls(intCNT).BladeClipColour
        End If
        If arrLouvreDetCls(intCNT).PileColourId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("PileColourId") = arrLouvreDetCls(intCNT).PileColourId
        End If
        If arrLouvreDetCls(intCNT).PileColour <> String.Empty Then
            dr("PileColour") = arrLouvreDetCls(intCNT).PileColour
        End If
        If arrLouvreDetCls(intCNT).MidRailHeight <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("MidRailHeight") = arrLouvreDetCls(intCNT).MidRailHeight
        End If
        If arrLouvreDetCls(intCNT).PivotTypeId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("PivotTypeId") = arrLouvreDetCls(intCNT).PivotTypeId
        End If
        If arrLouvreDetCls(intCNT).PivotType <> String.Empty Then
            dr("PivotType") = arrLouvreDetCls(intCNT).PivotType
        End If
        If arrLouvreDetCls(intCNT).FlushBoltsTopId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("FlushBoltsTopId") = arrLouvreDetCls(intCNT).FlushBoltsTopId
        End If
        If arrLouvreDetCls(intCNT).FlushBoltsTop <> String.Empty Then
            dr("FlushBoltsTop") = arrLouvreDetCls(intCNT).FlushBoltsTop
        End If
        If arrLouvreDetCls(intCNT).FlushBoltsBottomId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).LockOptionsId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("LockOptionsId") = arrLouvreDetCls(intCNT).LockOptionsId
        End If
        If arrLouvreDetCls(intCNT).LockOptions <> String.Empty Then
            dr("LockOptions") = arrLouvreDetCls(intCNT).LockOptions
        End If
        If arrLouvreDetCls(intCNT).BottomTrackTypeId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("BottomTrackTypeId") = arrLouvreDetCls(intCNT).BottomTrackTypeId
        End If
        If arrLouvreDetCls(intCNT).BottomTrackType <> String.Empty Then
            dr("BottomTrackType") = arrLouvreDetCls(intCNT).BottomTrackType
        End If
        If arrLouvreDetCls(intCNT).BladeLocks <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("BladeLocks") = arrLouvreDetCls(intCNT).BladeLocks
        End If
        If arrLouvreDetCls(intCNT).CChannel <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("CChannel") = arrLouvreDetCls(intCNT).CChannel
        End If
        If arrLouvreDetCls(intCNT).HChannel <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("HChannel") = arrLouvreDetCls(intCNT).HChannel
        End If
        If arrLouvreDetCls(intCNT).LChannel <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("LChannel") = arrLouvreDetCls(intCNT).LChannel
        End If
        If arrLouvreDetCls(intCNT).ZChannel <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("ZChannel") = arrLouvreDetCls(intCNT).ZChannel
        End If
        If arrLouvreDetCls(intCNT).ColourId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).CostPrice <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("CostPrice") = arrLouvreDetCls(intCNT).CostPrice
        End If
        If arrLouvreDetCls(intCNT).CostPriceGST <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("CostPriceGST") = arrLouvreDetCls(intCNT).CostPriceGST
        End If
        If arrLouvreDetCls(intCNT).ExtrasPrice <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("ExtrasPrice") = arrLouvreDetCls(intCNT).ExtrasPrice
        End If
        If arrLouvreDetCls(intCNT).ExtrasPriceGST <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("ExtrasPriceGST") = arrLouvreDetCls(intCNT).ExtrasPriceGST
        End If
        If arrLouvreDetCls(intCNT).SalePrice <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("SalePrice") = arrLouvreDetCls(intCNT).SalePrice
        End If
        If arrLouvreDetCls(intCNT).SalePriceGST <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("SalePriceGST") = arrLouvreDetCls(intCNT).SalePriceGST
        End If
        '
        dr("Deleted") = arrLouvreDetCls(intCNT).Deleted
        '
        If arrLouvreDetCls(intCNT).ShutterNo <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("ShutterNo") = arrLouvreDetCls(intCNT).ShutterNo
        End If
        If arrLouvreDetCls(intCNT).SlideId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("SlideId") = arrLouvreDetCls(intCNT).SlideId
        End If
        If arrLouvreDetCls(intCNT).Slide <> String.Empty Then
            dr("Slide") = arrLouvreDetCls(intCNT).Slide
        End If
        If arrLouvreDetCls(intCNT).StackerLocationId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).FinishTypeId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).InsertTopId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("InsertTopId") = arrLouvreDetCls(intCNT).InsertTopId
        End If
        If arrLouvreDetCls(intCNT).InsertTop <> String.Empty Then
            dr("InsertTop") = arrLouvreDetCls(intCNT).InsertTop
        End If
        If arrLouvreDetCls(intCNT).InsertBottomId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("InsertBottomId") = arrLouvreDetCls(intCNT).InsertBottomId
        End If
        If arrLouvreDetCls(intCNT).InsertBottom <> String.Empty Then
            dr("InsertBottom") = arrLouvreDetCls(intCNT).InsertBottom
        End If
        If arrLouvreDetCls(intCNT).BladeOperationId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).CurvedTrack <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("CurvedTrack") = arrLouvreDetCls(intCNT).CurvedTrack
        End If
        If arrLouvreDetCls(intCNT).ExtraTrack <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("ExtraTrack") = arrLouvreDetCls(intCNT).ExtraTrack
        End If
        If arrLouvreDetCls(intCNT).BladeOperationBottomId <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).FlyScreen <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("FlyScreen") = arrLouvreDetCls(intCNT).FlyScreen
        End If
        If arrLouvreDetCls(intCNT).Standoff <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("Standoff") = arrLouvreDetCls(intCNT).Standoff
        End If
        If arrLouvreDetCls(intCNT).Winder <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("Winder") = arrLouvreDetCls(intCNT).Winder
        End If
        If arrLouvreDetCls(intCNT).ControllerSideID <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).HighsetAllowance <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("HighsetAllowance") = arrLouvreDetCls(intCNT).HighsetAllowance
        End If
        If arrLouvreDetCls(intCNT).ExtrasCostPrice <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("ExtrasCostPrice") = arrLouvreDetCls(intCNT).ExtrasCostPrice
        End If
        If arrLouvreDetCls(intCNT).ExtrasCostPriceGST <> SharedConstants.DEFAULT_DECIMAL_VALUE Then
            dr("ExtrasCostPriceGST") = arrLouvreDetCls(intCNT).ExtrasCostPriceGST
        End If
        If arrLouvreDetCls(intCNT).Track <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).RemakeTypeID <> SharedConstants.DEFAULT_INTEGER_VALUE Then
        ...
        End If
        If arrLouvreDetCls(intCNT).TopTrackID <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("TopTrackID") = arrLouvreDetCls(intCNT).TopTrackID
        End If
        If arrLouvreDetCls(intCNT).FixedPanelChannel <> String.Empty Then
            dr("FixedPanelChannel") = arrLouvreDetCls(intCNT).FixedPanelChannel
        End If
        If arrLouvreDetCls(intCNT).FixedPanelChannelID <> SharedConstants.DEFAULT_INTEGER_VALUE Then
            dr("FixedPanelChannelID") = arrLouvreDetCls(intCNT).FixedPanelChannelID
        End If
        If arrLouvreDetCls(intCNT).OpenVertical <> SharedConstants.DEFAULT_INTEGER_VALUE Then
    ...
    Private Function mapArrByName(ByRef arrTMPs() As String, ByVal strMapVaue As String) As Integer
        ...
        Dim intMatchedID As Integer = SharedConstants.DEFAULT_INTEGER_VALUE
