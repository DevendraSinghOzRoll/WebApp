<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ScheduleDateUpdate.aspx.vb" Inherits="ScheduleDateUpdate" Theme="SknGridView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Schedule Date Update</title>
    ...
    <link href="favicon.ico" rel="shortcut icon" type="image/x-icon" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(function () {
                $("[id$=txtScheduleDate]").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1d', maxDate: '+1w' });
            });
...
<body onload="saveLocation();">
    ...
    <div id="middle-container-diallerview" >
        ...
        <div style="height: 50px; text-align: center;">
            <asp:Button ID="btnCancel" runat="server" CssClass="form-button" Text="Home" UseSubmitBehavior="false" />
            ...
            <ContentTemplate>
                ...
                <div style="text-align: center;">
                    <asp:GridView ID="dgvScheduleList" runat="server" DataKeyNames="ScheduleID" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" >
                        ...
                        <Columns>
                            <asp:BoundField DataField="ScheduleID" SortExpression="ScheduleID" HeaderText="ScheduleID" Visible="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="BranchName" SortExpression="BranchName" HeaderText="Branch" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  />
                            <asp:BoundField DataField="OrderReference" SortExpression="OrderReference" HeaderText="Reference No" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  />
                            <asp:BoundField DataField="CustomerName" SortExpression="CustomerName" HeaderText="Customer" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="OrderDate" SortExpression="OrderDate" HeaderText="Order Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d MMM yyyy}" />
                            <asp:BoundField DataField="TotalPanels" SortExpression="TotalPanels" HeaderText="No Of Panels" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  />
                            <asp:BoundField DataField="TotalSQM" SortExpression="TotalSQM" HeaderText="Total SqM" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="StatusName" SortExpression="StatusName" HeaderText="Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="Priority" SortExpression="Priority" HeaderText="Priority" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:TemplateField HeaderText="Scheduled Date" >
                            <ItemTemplate>
                                <asp:TextBox ID="txtScheduleDate" runat="server" AutoPostBack="true" OnTextChanged="txtScheduleDate_TextChanged" Text='<%#  GetDate(Eval("ScheduledDate")) %>' class="txtDatePicker" CssClass="form-field" Width="120px" Height="20px"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                    <div style="text-align: center;">
                        <img id="imgLoading" src="images/indicator.gif" width="16px" height="16px" alt="loading" style="visibility: hidden; vertical-align: middle;" />&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>  
                    <div style="text-align: center;">
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            $("input#txtScheduleDate").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1d', maxDate: '+1w' });
        });    
    </script>
