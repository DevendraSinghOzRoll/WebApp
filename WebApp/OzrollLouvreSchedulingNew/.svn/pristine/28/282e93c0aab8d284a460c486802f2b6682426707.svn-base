<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateCollectedFromFactory.aspx.vb" Inherits="UpdateCollectedFromFactory" Theme="SknGridView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Collected From Factory Update</title>
    ...
    <link href="favicon.ico" rel="shortcut icon" type="image/x-icon" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            $("[id$=txtCollectedDate]").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1d', maxDate: '+5w' });
...
<body onload="saveLocation();">
    ...
    <div id="middle-container-diallerview" >
        ...
        <h1>Collected From Factory Update</h1>

        <div class="form" style="text-align: center;">

            <div style="text-align: center;">
                Collected From Factory Date:&nbsp;<asp:TextBox ID="txtCollectedDate" runat="server" CssClass="form-field" Text="" Width="120px" />
            </div>
            ...
            <ContentTemplate>
                ...
                <div style="text-align: center;">
                    <asp:GridView ID="dgvCollectedList" runat="server" DataKeyNames="ScheduleID" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Collected">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chkCollected" Checked='<%#Convert.ToBoolean(Eval("Collected")) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
    ...
    <script type="text/javascript">
        $(function () {
            $("input#txtCollectedDate").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd M yy', gotoCurrent: true, showAnim: 'slideDown', minDate: '-1d', maxDate: '+5w' });
        });
    </script>
