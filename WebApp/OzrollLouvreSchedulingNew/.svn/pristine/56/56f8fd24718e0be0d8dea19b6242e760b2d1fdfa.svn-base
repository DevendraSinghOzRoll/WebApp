...
Public Class DailyScheduleExport
    ...
    Public Shared Sub loadDailyScheduleExportData(dtReportData As DataTable, ByRef xlWks As ExcelWorksheet)
        ...
        For i As Integer = 0 To dtReportData.Rows.Count - 1
            ...
            If Not IsDBNull(dtReportData.Rows(i)("hidFramingStatus")) Then
                ...
                End If
            End If
            If Not IsDBNull(dtReportData.Rows(i)("hidFramingDate")) Then
                xlWks.Cells(intRowNum, intColNum).Value = CDate(dtReportData.Rows(i)("hidFramingDate")).ToString("d MMM yyyy")
            End If
            intColNum += 1
            ...
            End If
            intColNum += 1
            If Not IsDBNull(dtReportData.Rows(i)("hidWrappingDate")) Then
                xlWks.Cells(intRowNum, intColNum).Value = CDate(dtReportData.Rows(i)("hidWrappingDate")).ToString("d MMM yyyy")
            End If
            intColNum += 1
